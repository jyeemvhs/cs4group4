...
console.log("get successsignup");
    ...
    else
    {
      ...
      res.json({redirect:"/intro",ident:identA});    
    }
});
...
router.get("/intro", function(req, res) {
  ...
  if (req.isAuthenticated()) {
    console.log("sendFile intro.html")
let thePath = path.resolve(__dirname,"public/views/intro.html");
res.sendFile(thePath);
  } else {
...
router.get("/gameOver", function(req, res) {
  ...
  if (req.isAuthenticated()) {
    console.log("sendFile gameOver.html")
let thePath = path.resolve(__dirname,"public/views/gameOver.html");
res.sendFile(thePath);
  } else {
    console.log("sendFile gameOver.html")
  let thePath = path.resolve(__dirname,"public/views/login.html");
...
router.get("/leaderBoard", function(req, res) {
  ...
  if (req.isAuthenticated()) {
    console.log("sendFile leaderBoard.html")
let thePath = path.resolve(__dirname,"public/views/leaderBoard.html");
res.sendFile(thePath);
  } else {
    console.log("sendFile leaderBoard.html")
  let thePath = path.resolve(__dirname,"public/views/login.html");
